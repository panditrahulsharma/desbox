                ...
                <div class="row">
                     ...
                     <%
                             ...
                             try
                             {
                                ...
                                rs3=st3.executeQuery("select cname from classcreate where classcode='"+a1[j]+"'");
                                while(rs3.next())
                                {
                                    s9=rs3.getString(1);
                                }
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">class <%=s9 %></h4>
                                <p class="category">class code <%= a1[j] %></p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                ...
                                rs1=st1.executeQuery("select name,email,dat from join1 where classcode='"+a1[j]+"'");
                               ...
                               %>
                                            ...
                                            <td>1</td>
                                            <td><%= s6 %></td>
                                           <td><a href="mail1.jsp?k=<%= s7 %>"><%= s7 %></a></td>
                                           <td><%= s8 %></td>
                                        </tr>
                                    </tbody>
                                  <%
