...
<html lang="en">
    ...
    <head>
        ...
        <title>Post and share Files</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="imageupload panel panel-default">
                ...
                <div class="file-tab panel-body">
                    <label class="btn btn-default btn-file">
                        ...
                        <form action="file.jsp" id="form1" enctype = "multipart/form-data" method="post">
            ...
            <button type="Submit"  class="btn btn-danger" form="form1">Submit</button>
        ...
        <div class="container">
            ...
            <div class="imageupload panel panel-default">
                <div class="panel-heading clearfix">
                    ...
                    <div class="btn-group pull-right">
                        <button type="button" class="btn btn-default active">Pdf File</button>
                              </div>
                </div>
                <div class="file-tab panel-body">
                    <label class="btn btn-default btn-file">
                        <span>Browse</span>
                        <!-- The file is stored here. -->
                        <form action="file1.jsp" id="form11" enctype = "multipart/form-data" method="post">
                        <input type="file" name="image-file">
                    </form>
                    </label>
                    <button type="button" class="btn btn-default">Remove</button>
            ...
            <!-- bootstrap-imageupload method buttons. -->
            <button type="Submit"  class="btn btn-danger" form="form11">Submit</button>
            <button type="button" id="imageupload-enable" class="btn btn-success">Enable</button>
            <button type="button" id="imageupload-reset" class="btn btn-primary" >Reset</button>
