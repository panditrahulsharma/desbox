                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="classcreate.jsp" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Data Structure Assignment"  required="" name="k1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Section</label>
                                                <input type="text" class="form-control" placeholder="section A" name="k2" required="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Subject</label>
                                                <input type="text" class="form-control" placeholder="Data Structure" name="k3" required="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="50 Marks" name="k4" value="optional">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Submission Time(Optional)</label>
                                                <input type="text" class="form-control" placeholder="30-2-2019" name="k5" value="optional" >
                                            </div>
                                        </div>
