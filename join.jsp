            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Join Class</h4>
                            </div>
                            <div class="content">
                                <form action="classjoin.jsp" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="78@&fhh" name="k2">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Join</button>
